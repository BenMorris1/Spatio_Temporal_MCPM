...
##### Import the data
crime_counts = np.genfromtxt(os.path.join(os.path.dirname(__file__), "..") + '/Data/crime_experiments/crime_counts_final')

# Import index for cell inside NY (1) and cell outside NY (0)
cell_inside_ny = np.genfromtxt(os.path.join(os.path.dirname(__file__), "..") + '/Data/crime_experiments/cell_inside_ny')
...
np.savetxt(os.path.join(os.path.dirname(__file__), "..") + '/Data/crime_experiments/original_inputs_crime', crime_counts[:,1:3])
np.savetxt(os.path.join(os.path.dirname(__file__), "..") + '/Data/crime_experiments/inputs_crime', inputs)
np.savetxt(os.path.join(os.path.dirname(__file__), "..") + '/Data/crime_experiments/outputs_crime', outputs)
np.savetxt(os.path.join(os.path.dirname(__file__), "..") + '/Data/crime_experiments/task_features_crime', task_features)
...
if method == "MCPM":
	def Full_MCPM_learning(fold):
		...
		np.save(os.path.join(os.path.dirname(__file__), "..") + '/Data/crime_experiments/outputs_inputs_na_crime' + str(fold), outputs_inputs_na)
...
######## SAVING RESULTS
folder = os.path.join(os.path.dirname(__file__), "..") + '/Data/crime_experiments/'
