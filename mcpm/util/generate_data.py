...
def generate_missing_data_uk_crime(outputs, missing_experiment):
    
    index1 = np.concatenate((range(10,35),range(54,79)))
    index2 = np.concatenate((range(430,440),range(474,484),range(518,528),range(562,572),range(606,616)))
    index3 = np.concatenate((range(120,130),range(154,174),range(198,218)))
    index4 = np.concatenate((range(50,75),range(94,119)))
    index5 = np.concatenate((range(1295,1305),range(1339,1349),range(1383,1393),range(1427,1437),range(1471,1481)))
    index6 = np.concatenate((range(904,924),range(948,968),range(992,1002)))
    index7 = np.concatenate((range(1427,1452),range(1471,1496)))
    index8 = np.concatenate((range(750,775),range(794,819)))
    index9 = np.concatenate((range(550,570),range(594,614),range(638,648)))
    index10 = np.concatenate((range(250,260),range(294,304),range(338,348),range(382,392),range(426,436)))
    index11 = np.concatenate((range(826,836),range(870,880),range(914,924),range(958,968),range(1002,1012)))
    index12 = np.concatenate((range(635,660),range(679,704)))
    index13 = np.concatenate((range(1101,1121),range(1145,1165),range(1189,1199)))
    index14 = np.concatenate((range(1453,1478),range(1497,1522)))
    ...
    if missing_experiment == True:
        ...
        outputs[index5,4] = np.nan
        outputs[index6,5] = np.nan
        outputs[index7,6] = np.nan
        outputs[index8,7] = np.nan
        outputs[index9,8] = np.nan
        outputs[index10,9] = np.nan
        outputs[index11,10] = np.nan
        outputs[index12,11] = np.nan
        outputs[index13,12] = np.nan
        outputs[index14,13] = np.nan

	# Define the indeces for non missing obs data
    ytrain_non_missing_index = ~np.isnan(outputs)

    return (ytrain_non_missing_index)
